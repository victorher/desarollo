        ...
        <section class="contenedor">
            <div class="cuerpo" style="height: 400px">
                <div class="formularioActualizar" id="formularioActualizar">
                    <h2>Registrar un nuevo proveedor</h2>
                    <form action="" method="POST">
                        ...
                        <div class="formularioGrupo">
                            <input type="text" class="direccion" id="adress" name="direccion" required="">
                            <span class="barra"></span>
                            <label>Direccion</label>
                        </div>
                        <div class="formularioGrupo">
                            <input type="text" class="telefono" id="cell" name="telefono" required="">
                            <span class="barra"></span>
                            <label>Telefono</label>
                        </div>
                        <div class="formularioGrupo">
                            <input type="text" class="correo" id="mail" name="correo" required="">
                            <span class="barra"></span>
                            <label>Correo</label>
                        </div>
                        <div class="formularioGrupo">
                            <input type="text" class="categoria" id="categoria" name="categoria" required="">
                            <span class="barra"></span>
                            <label>Categoria</label>
                        </div>
                        <input type="hidden" class="estado" id="estado" name="estado" value="Activo">
                        <button type="submit" class="btncarga" name="CargaPro">Registrar <i class="fa fa-sign-in ml-1"></i></button>
                    </form>
                </div>
            </div>
        </section>
